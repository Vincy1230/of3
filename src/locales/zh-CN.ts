...
export default {
  ...
  validation: {
    ...
    rootNotObject: 'JSON 根节点必须是一个带有 "queries" 字段的对象。',
    queriesInvalid: '"queries" 必须是一个以 query key 映射到 query 对象的对象。',
    queriesEmpty: '"queries" 里还没有任何 query。',
    ...
    chainIdsEmpty: '链标识不能为空。',
    chainIdsDuplicate: '链标识 "{id}" 在这个 Query 中重复。',
